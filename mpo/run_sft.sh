...
# ===============================
# model 4 - llama7b (ưu tiên)
# ===============================
echo "=== SFT model=4 (llama7b) ==="
CUDA_VISIBLE_DEVICES=7 bash run_all.sh 4 1 DPO 1 &   # hh
CUDA_VISIBLE_DEVICES=5 bash run_all.sh 4 2 DPO 1 &   # shp
wait
CUDA_VISIBLE_DEVICES=7 bash run_all.sh 4 3 DPO 1 &   # pku
CUDA_VISIBLE_DEVICES=5 bash run_all.sh 4 4 DPO 1 &   # ultrabin
wait
CUDA_VISIBLE_DEVICES=7 bash run_all.sh 4 5 DPO 1 &   # ultrallama
CUDA_VISIBLE_DEVICES=5 bash run_all.sh 4 6 DPO 1 &   # ultragemma
wait
